            ...
            <div class="row justify-content-center">
                <div class="p-5 container-card rounded-3 border col-xl-6 shadow">
                    <div class="mb-3 text-center">
                        <h4 class="fw-bold">Create Beasiswa</h4>
                    </div>
                    <hr>
                    <div class="row">
                        <div class="col-md-12">
                            ...
                            <input class="form-control @error('nama') is-invalid @enderror" type="text" name="nama"
                                id="nama" value="{{ old('nama') }}" placeholder="Isi Nama Beasiswa">
                            @error('nama')
                    ...
                    <div class="row">
                        <div class="col-md-6 d-grid">
                            <a href="{{ route('beasiswas.index') }}" class="btn btn-outline-dark btn-cancle btn-lg mt-3 fw-bold"><i
