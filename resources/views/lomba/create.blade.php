        ...
        <form action="{{ route('lombas.store') }}" method="POST" enctype="multipart/form-data">
            ...
            <div class="row justify-content-center">
                    ...
                    <div class="mb-3 text-center">
                        <h4 class="fw-bold">Create Lomba</h4>
                    </div>
                    <hr>
                    <div class="row">
                        <div class="col-md-12">
                            ...
                            <input class="form-control @error('nama') is-invalid @enderror" type="text" name="nama"
                                id="nama" value="{{ old('nama') }}" placeholder="Isi Nama Lomba">
                            @error('nama')
                    ...
                    <div class="row">
                        <div class="col-md-6 d-grid">
                            <a href="{{ route('lombas.index') }}" class="btn btn-outline-dark btn-cancle btn-lg mt-3 fw-bold"><i
